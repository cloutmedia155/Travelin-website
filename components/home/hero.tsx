...
export function Hero() {
  ...
  return (
    <section id="home" className="hero" data-media-failed={mediaFailed || undefined} aria-label="Your journey starts here">
      <div className="hero-sticky">
        <div className="hero-scene">
          <video className="hero-film" src="/media/door-journey.mp4" muted playsInline preload="auto" poster="/media/door-poster.webp" aria-hidden="true" onError={() => setMediaFailed(true)} />
        ...
        <div className="hero-copy hero-title">
          ...
          <p className="hero-offer">Personally hosted group trips with Olivia.</p>
        </div>
